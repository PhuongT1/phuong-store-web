...
export type TransactionCashDeliveryInitializeMutationVariables<T = unknown> = Exact<{
	checkoutId: Scalars["ID"];
	paymentGatewayId: string;
	data: T;
}>;

export type TransactionInitializeResult = {
	__typename?: "TransactionInitialize";
	data?: Record<string, any> | null;
	transaction?: {
		__typename?: "TransactionItem";
...
export type TransactionInitializeData = TransactionInitializeResult | null;
export type TransactionInitializeMutation = {
	__typename?: "Mutation";
	transactionInitialize?: TransactionInitializeData;
};
...
`;
export const TransactionCashDeliveryInitializeDocument = gql`
...
export function useTransactionCashDeliveryInitializeMutation() {
	return Urql.useMutation<TransactionInitializeMutation, TransactionCashDeliveryInitializeMutationVariables>(
		TransactionCashDeliveryInitializeDocument,
	);
}
