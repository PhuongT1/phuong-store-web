...
import { type CheckoutEmailUpdateMutation, type CheckoutEmailUpdateMutationVariables, CheckoutEmailUpdateDocument } from "@/gql/graphql";
...
export const useCheckoutEmailUpdate = ({ email }: CheckoutEmailUpdateFormData) => {
	const [, updateEmail] = useMutation<CheckoutEmailUpdateMutation, CheckoutEmailUpdateMutationVariables>(CheckoutEmailUpdateDocument);
