...
export function CheckoutForm() {
	...
	return (
		<form className="my-8 flex flex-col gap-y-6" onSubmit={onSubmitInitialize}>
			...
			<button
				className="bg-foreground text-background hover:bg-foreground/90 hover:disabled:bg-foreground/70 hover:aria-disabled:bg-foreground/70 h-12 items-center rounded-md px-6 py-3 text-base leading-6 font-medium shadow disabled:cursor-not-allowed disabled:opacity-70 aria-disabled:cursor-not-allowed aria-disabled:opacity-70"
	...
	return (
		<div className="text-center" aria-busy="true" role="status">
			<div>
				<svg
					aria-hidden="true"
					className="fill-muted-foreground text-muted mr-2 inline h-6 w-6 animate-spin"
					viewBox="0 0 100 101"
					fill="none"
