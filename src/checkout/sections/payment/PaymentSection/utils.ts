...
import { type PaymentStatus } from "@/checkout/sections/payment/PaymentSection/types";
import {
...
export const supportedPaymentGateways = [adyenGatewayId, stripeGatewayId, vnpayGatewayId] as const;
