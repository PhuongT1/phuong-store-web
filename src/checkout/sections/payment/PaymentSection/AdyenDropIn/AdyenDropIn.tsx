...
import { type AdyenGatewayInitializePayload } from "@/checkout/sections/payment/PaymentSection/AdyenDropIn/types";
import {
	type AdyenDropinProps,
	useAdyenDropin
} from "@/checkout/sections/payment/PaymentSection/AdyenDropIn/useAdyenDropin";
import { createAdyenCheckoutConfig } from "@/checkout/sections/payment/PaymentSection/AdyenDropIn/utils";
...
const _hack = (adyenCheckout: AdyenCheckoutInstance) =>
	// @ts-expect-error -- Adyen v6 removed .create(), type workaround
