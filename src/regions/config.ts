import type { Language, LanguageId, Locale, Market, MarketId, SUPPORTED_MARKETS } from "@/regions/types";

export const LOCALE_CHANNEL_MAP: Record<Locale, (typeof SUPPORTED_MARKETS)[number]> = {
	"en-GB": "gb",
	"en-US": "us"
};
