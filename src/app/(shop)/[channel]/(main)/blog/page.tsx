...
export const metadata: Metadata = {
	title: "Blog — Phương Store",
	description: "Tin tức, hướng dẫn và cảm hứng thời trang từ Phương Store."
};
		...
		<>
			...
			<div className="from-primary/10 via-info/5 to-success/10 border-border border-b bg-gradient-to-r">
				<ContainerLayout className="py-12">
					<p className="text-primary mb-1 text-xs font-semibold tracking-[0.2em] uppercase">Phương Store</p>
