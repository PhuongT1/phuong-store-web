...
const ProductCardInner = ({
	...
	return (
		<li
			...
			className={cn(
				"group product-card-premium surface-card surface-card-interactive relative flex flex-col overflow-hidden rounded-[1.1rem]",
				className
			)}
		>
			<LinkWithChannel href={`/products/${product.slug}`} className="flex h-full flex-col">
				...
				<div className="flex flex-1 flex-col gap-2.5 p-3 sm:p-3.5">
					...
					<div className="mt-auto">
						...
						<div className="text-muted-foreground mb-2 flex items-center px-0.5 text-[11px] sm:text-[13px]">
						...
						<button
							...
							className={cn(
								...
								isInStock
									? "border border-info/25 bg-linear-to-r from-info/10 via-info/12 to-info/9 text-info hover:border-info/45 hover:from-info/15 hover:to-info/12 hover:shadow-[0_14px_28px_-20px_rgba(56,189,248,0.80)] disabled:opacity-50 dark:border-info/35 dark:from-info/18 dark:via-info/16 dark:to-info/12"
