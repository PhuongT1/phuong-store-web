...
export async function Footer({ channel }: { channel: string }) {
	...
	return (
		<footer className="border-border/40 bg-card mt-0 border-t py-10 shadow-[0_-2px_10px_rgba(0,0,0,0.03)] transition-all duration-300">
			<ContainerLayout>
				...
				<div className="grid w-full grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-4">
					...
					<div className="flex flex-col">
						...
						<p className="text-muted-foreground mb-8 pr-4 text-[13px] leading-relaxed">{t("description")}</p>
...
const SocialIcon = ({ d }: { d: string }) => (
	<div className="text-foreground hover:bg-accent flex h-10 w-10 cursor-pointer items-center justify-center rounded-full transition-all active:scale-95">
