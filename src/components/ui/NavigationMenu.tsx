...
const NavigationMenuList = React.forwardRef<
	...
	React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitive.List> & { hasIndicator?: boolean }
>(({ className, children, hasIndicator = true, ...props }, ref) => (
	<NavigationMenuPrimitive.List
		ref={ref}
		className={cn("group flex flex-1 list-none flex-wrap items-center space-x-1", className)}
		{...props}
	>
		{children}
	</NavigationMenuPrimitive.List>
...
const navigationMenuTriggerStyle = cva(
	`group inline-flex h-9 w-max items-center justify-center rounded-none px-3 text-[14px] font-semibold tracking-normal transition-colors hover:bg-accent hover:text-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[state=open]:bg-accent`
);
...
>(({ className, ...props }, ref) => (
	<NavigationMenuPrimitive.Indicator ref={ref} {...props}></NavigationMenuPrimitive.Indicator>
));
